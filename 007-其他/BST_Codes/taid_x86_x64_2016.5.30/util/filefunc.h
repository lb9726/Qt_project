...
#define        D_FILEPACKAGE_SIZE   1064960 //10Mb
...
bool TCopyFile(QString srcFile, QString dstFile, int *pControl = 0, pShowInfo *pShowFunc = 0);
...
public:
    ...
    void TCopyFile(QString srcFile, QString dstFile, pShowInfo *pShowFunc = 0);
