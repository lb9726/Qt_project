...
public:
    ...
    void initCanopenClient();

    void rPDOArrived(int pdoIndex);
    void sSDOArrived(int sdoIndex);
    void rPDO1Arrived();
    void rPDO2Arrived();
    void rPDO3Arrived();
    void rPDO4Arrived();
...
signals:
    ...
    void sigButtonLightOn(int btIndex,bool isBuzz= true);
    ///RPDO2
