...
void usbmanager::getDevice(QDBusInterface *interface,const QString &udi)
{
        ...
        )
    {
        ...
        informationCenter->connection().connect(DBUS_HAL_SERVICE, udi, DBUS_HAL_DEVICE_INTERFACE, "PropertyModified", dev, SLOT(propertyModified(int,const QList<ChangeStruct>&)));
        }
