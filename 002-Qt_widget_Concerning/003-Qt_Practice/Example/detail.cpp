...
Detail::Detail(QWidget *parent) : QWidget(parent)
{
    ...
    ProvincelLabel = new QLabel(tr("省份"));
    ProvinceComboBox = new QComboBox;
    ProvinceComboBox -> insertItem(0,tr("江苏省"));
    ProvinceComboBox -> insertItem(1,tr("山东省"));
    ProvinceComboBox -> insertItem(2,tr("浙江省"));
    ProvinceComboBox -> insertItem(3,tr("安徽省"));
    ProvinceComboBox -> insertItem(4,tr("江西省"));
    ProvinceComboBox -> insertItem(5,tr("海南省"));
    ...
    mainLayout = new QGridLayout(this);   // this 不能漏写，否则没有画面
    mainLayout -> setMargin(15);
    mainLayout -> setSpacing(10);
    mainLayout -> addWidget(NationalLabel,0,0);
    mainLayout -> addWidget(NationalComboBox,0,1);
    mainLayout -> addWidget(ProvincelLabel,1,0);
