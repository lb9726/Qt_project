...
//                                            language_english.checked, language_russian.checked)
                    ...
                    style: RadioButtonStyle {
                        label: Label {
                            id: cBoxlabel_language_chinese
                            text: language_chinese.text
                            font.family: "KONE Information_v12"
                        }
                    }
                }
                RadioButton {
                    ...
                    style: RadioButtonStyle {
                        label: Label {
                            id: cBoxlabel_language_tradition
                            text: language_tradition.text
                            font.family: "KONE Information_v12"
                        }
                    }
                }
            ...
            ColumnLayout {
                ...
                RadioButton {
                    ...
                    style: RadioButtonStyle {
                        label: Label {
                            id: cBoxlabel_language_english
                            text: language_english.text
                            font.family: "KONE Information_v12"
                        }
                    }
                }
                RadioButton {
                    ...
                    style: RadioButtonStyle {
                        label: Label {
                            id: cBoxlabel_language_russian
                            text: language_russian.text
                            font.family: "KONE Information_v12"
                        }
                    }
                }
