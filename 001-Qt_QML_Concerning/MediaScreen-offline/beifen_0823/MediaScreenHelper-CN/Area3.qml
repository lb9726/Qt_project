        ...
        ColumnLayout {
            ...
            RadioButton {
                ...
                style: RadioButtonStyle {
                    label: Label {
                        id: cBoxlabel_normal_show
                        text: normal_show.text
                        font.family: "KONE Information_v12"
                    }
                }

//                FontMetrics.font.family: "KONE Information_v12"
            }
            RadioButton {
                id: fullscreen_show
                exclusiveGroup: showGroup
                ...
                style: RadioButtonStyle {
                    label: Label {
                        id: cBoxlabel_fullscreen_show
                        text: fullscreen_show.text
                        font.family: "KONE Information_v12"
                    }
                }
            }
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            RadioButton {
                ...
                style: RadioButtonStyle {
                    label: Label {
                        id: cBoxlabel_video_text_btn
                        text: video_text_btn.text
                        font.family: "KONE Information_v12"
                    }
                }
            }
            RadioButton {
                ...
                style: RadioButtonStyle {
                    label: Label {
                        id: cBoxlabel_picture_text_btn
                        text: picture_text_btn.text
                        font.family: "KONE Information_v12"
                    }
                }
            }
...
//            }
            Button {
                ...
                text: qsTr("选择视频")
                onClicked: {
                    addVideo(); select_btn_video.text = "libo"
                }
                style: ButtonStyle {
                    background: BorderImage {
                        source: select_btn_video.pressed ? "qrc:///image/Brown.png":"qrc:///image/blue.png"
    ...
    Item {
        ...
        Button {
            ...
            style: ButtonStyle {
                background: BorderImage {
                    source: select_picture_btn.pressed ? "qrc:///image/Brown.png":"qrc:///image/blue.png"
