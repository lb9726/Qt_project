...
public:
    ...
    void disconnectSafSignal(bool pAutoTest);
...
private:
    ...
    void setProgressGeometry();
    void setWifiIconGeometry();
    void recordSnapShot();      // 记录手机端发送AutoTest指令之前的状态
    void recoverySnapShot();    // 恢复手机端发送AutoTest指令之前的状态
    void initZipFunction();
...
signals:
    ...
    void sigUsbInsert();
    void sigUsbRemove();
    void sigLoginMessage(bool flag);
    void sigDestroyZip();
...
public slots:
    ...
    void loginMessage(bool flag);
    void destroyZipFuntion();
...
private:
    ...
    QString                    mRunPath;
    QString                    mCanopenMessageStatus;
    QString                    mCanopenPreStatus;
    QString                    mCanopenCurStatus;
    QString                    mStatusSafProtocol;
    ZipFunction                *mZipFunction;
//    ZipAndUnZip                *mZipFunction;
...
//    int                        mUdpPort;
    ...
    int                        mLastShi;
    int                        mLastBai;
    int                        mLastStackWidgetIndex;
    bool                       mIsSendZipFile;
    int                        mIsSendZipFileProgress;
    /*-------------Wifi end-------------------*/
...
public slots:
    ...
    void slot_ArrowAction_CanOpen(bool pArrows_FLM, bool pArrows_FLD, bool pArrows_SCROL);
...
//    void slot_CanopenshortBuzz();
    ...
    void sltUploadProgress(int progress);
    void sltUnzipFileErrors();
    void sltRebootMachine(bool flag);
    void sltShowZipConcernMessage(QString msg);
    /**/
};
