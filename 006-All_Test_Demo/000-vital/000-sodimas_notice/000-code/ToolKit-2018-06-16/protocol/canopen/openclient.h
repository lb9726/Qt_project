...
private:
    void linkCharacterForRpdo3(int curLine, int curClume);
    void linkCharacterForRpdo4(int curLine, int curClume);
    void buildMessageAndEmitSignal(bool pflag);
    void judgeSmallOrBigTextChang();
    void resetAfterEmptyCharacter(int isSmallText);
...
private:
    ...
    UNS8 preRealtimeMsg[2][24];
    UNS8 fullscrennMsg[4][16];
    UNS8 preFullscrennMsg[4][16];
    int mCurline;
    int mCurcolumn;
};
