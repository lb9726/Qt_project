...
//        title_id.text = qsTr("标题")
    ...
    function updateParameterSetting1()
    {
        ...
        if (isBrightnessVolume && isScrollText && isTitle)
        {
            ...
            ConfigureSerialer.updateParameterBasic1(false,
                false, false, false, false, false, hasChoiceScrollTextFlag, hasChoiceTitleShowFlag);
        }
        else
        {
            console.log("not full false")
            ConfigureSerialer.updateParameterBasic1(true,
                isBrightnessVolume, !isScrollText, !isTitle, !isScrollText, !isTitle, hasChoiceScrollTextFlag, hasChoiceTitleShowFlag)
        }
        ...
        ConfigureSerialer.setSystimeText(systimeEditText.getEditTime(),
            !id_systimeSwitch.checked)
    }
