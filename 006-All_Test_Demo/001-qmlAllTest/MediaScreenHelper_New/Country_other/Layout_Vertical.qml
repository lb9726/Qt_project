...
Rectangle {
    ...
    Item {
        ...
        MediaPlayer{
            ...
            onStopped: {
                console.log("layout_vertical the media is end!")
            }
            onPlaying: {
                console.log("layout_vertical is playing")
            }
        }
        VideoOutput {
            width: parent.width; height: parent.height
...
//        console.log("curImageindex = ", curImageindex)
    ...
    function stopAudio()
    {
        if (isAudio)
        {
            ...
            {
                player.stop();
                console.log("receive signal stop audio in vertical")
            }
        }
        else if (isVideo)
        {
            ...
            {
                player.stop();
                console.log("receive signal stop video in vertical")
            }
        }
    }
    ...
    function pauseorplay()
    {
        ...
        else if (isAudio)
        {
            if (1 === playStatus)
            {
                playStatus = 0;
                player.pause();
                console.log("Vertical is call pause");
            }
            else
            {
                playStatus = 1;
                player.play();
                console.log("Vertical is call play");
            }
        }
    }
    ...
    function autoPlay_Audio()
    {
        if (isAudio)
        {
            ...
            console.log("functiong in autoplay in layout_vertical in normal languange")
        }
        else if (isVideo)
        {
            if (player.PlayingState != player.playbackState)
            ...
            console.log("video functiong in autoplay in layout_vertical in normal languange")
        }
    }
    ...
    function clearAllParament()
    {
        ...
        isPicture  = false;
        videoPath = "";
        console.log("vertical in normal is clearpara")
    }
    ...
    function countScrollLengthAndRestart()
    {
        ...
        if ("" !== scrollText)
        {
            ...
            console.log("vertical in normal scroll_text.width and restart = ", scrollend ) ;
        }
        else
        {
            anima_scroll.stop();
            console.log("scroll is empty vertical in normal will stop");
        }
        console.log("vertical in normal in countScrollLengthAndRestart()")
    }
    ...
    Connections {
        ...
        onClearAudioParament: {
            if (3 === lan_index)
            {
                console.log("vertical in normal is clearPara lan_index = ", lan_index);
                clearAllParament();
            }
        }
    }
    ...
    Connections {
        ...
        onVerticalAudioAutoPlay: {
            autoPlay_Audio();
            console.log("vertical audio will play");
            countScrollLengthAndRestart();
            console.log("vertical in normal scroll_text.width = ", scrollend ) ;
        }
    }
    ...
    Connections {
        ...
        onStopAllAudioPlay: {
            stopAudio();
            console.log("stopAudio is call in vertical")
        }
    }
    ...
    Connections {
        ...
        onGetScrollTextLengthSignal: {
            countScrollLengthAndRestart();
            console.log("getsignal vertical in normal scroll_text.width = ", scrollend ) ;
        }
    }

    Component.onCompleted: {
        console.log("layout_vertical is completed")
    }
}
