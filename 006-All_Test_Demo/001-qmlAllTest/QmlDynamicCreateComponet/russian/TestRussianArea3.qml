...
Item {
    ...
    Item {
        ...
        Button {
            ...
            // text: qsTr("选择视频")
            text: qsTr("Выбор видео")
            onClicked: {
                addVideo();
            }
            style: ButtonStyle {
                background: BorderImage {
                    source: select_btn_video.pressed ? "qrc:///image/Brown_195.png":"qrc:///image/Blue_195.png"
    ...
    Item {
        ...
        Button {
            ...
            id: select_btn_audio
            anchors.centerIn: parent
            text: qsTr("выбрать аудио") // 选择音频
            onClicked: {
                addAudio();
            }
            style: ButtonStyle {
                background: BorderImage {
                    source: select_btn_audio.pressed ? "qrc:///image/Brown_195.png":"qrc:///image/Blue_195.png"
    ...
    Item {
        ...
        Button {
            ...
            style: ButtonStyle {
                background: BorderImage {
                    source: select_picture_btn.pressed ? "qrc:///image/Brown_195.png":"qrc:///image/Blue_195.png"
