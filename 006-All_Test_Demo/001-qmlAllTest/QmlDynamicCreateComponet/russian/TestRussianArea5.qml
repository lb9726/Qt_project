...
Item {
    ...
    Button {
        ...
        x: 330 + 260
        y: 28
        text: qsTr("Поделка")  //  text: qsTr("制作")
    ...
    function makeDisk()
    {
        ...
        ConfigureSerialer.delDir(id_currentUsbDriver.currentText + "\\update\\");
        id_copyTimer.start();
