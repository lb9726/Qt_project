...
//        }
    ...
    {
        console.log("will copy videopath is", videoPath )
        if(!multimediaSwitcher)
        {
            console.log("all is not select")
        ...
        else
        {
            ...
            if(choseVideo)
            {
                console.log("video is select",videoPath)
                res = videoPath;
            }
            else if (choseAudio)
            {
            ...
            console.log("will copy videopath res is", res );
